# Camerobot + 云径 CinePath

个人机器人摄影师 Pro：一个“类人型陪伴 + 专业摄影 + 无人机 + 轻摇臂 +
移动储物”的机器人系统。

## 云径 CinePath（A：框架 / 技术 Demo）
...
仓库根目录包含一个零构建静态页面，可直接被 Vercel 托管：
...
页面展示 Camerobot 的产品定位、软件链路、MVP 路线，并提供一个浏览器本地的
Shot Plan 演示。Vercel 部署时不需要安装依赖或执行构建命令，输出目录保持仓库
根目录即可。
